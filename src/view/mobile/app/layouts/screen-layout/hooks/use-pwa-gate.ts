import { GlobalRouteNames } from '@/view/mobile/shared/consts/paths';
import { LS_INFO_BLOCK_KEY } from '@/view/mobile/shared/lib/info';
import { getIsStandalone } from '@/view/mobile/shared/lib/mobile';
